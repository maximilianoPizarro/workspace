...
public class TestFunciones {
	...
	public static void main(String[] args) {
		...
		//Serán bisiestos los años divisibles por 4, exceptuando los que son divisibles por 100 y no divisibles
		//por 400.
		...
		//5) + esFechaValida (parámetros int anio, int mes de 1 a 12, int dia)
		...
		//7) + traerFecha (String fecha) : GregorianCalendar //parámetro de la forma “dd/mm/aaaa”	
		...
		//9) + esDiaHabil (GregorianCalendar fecha) : boolean //Consideramos hábil de lunes a viernes.
